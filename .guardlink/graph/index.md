...
| [`blame.flows.mmd`](by-asset/blame.flows.mmd) | #blame and its flow neighbourhood, grown until the drawing stopped fitting — 25 neighbour(s) one hop out are not shown |
...
| [`cli.flows.mmd`](by-asset/cli.flows.mmd) | #cli and its flow neighbourhood, grown until the drawing stopped fitting — 23 neighbour(s) one hop out are not shown |
...
| [`estate-view.threats.mmd`](by-asset/estate-view.threats.mmd) | #estate-view only — its own threats and controls |
| [`estate-view.flows.mmd`](by-asset/estate-view.flows.mmd) | #estate-view and its flow neighbourhood, grown until the drawing stopped fitting — 21 neighbour(s) one hop out are not shown |
...
| [`workspace-link.flows.mmd`](by-asset/workspace-link.flows.mmd) | #workspace-link and its flow neighbourhood, grown until the drawing stopped fitting — 38 neighbour(s) one hop out are not shown |
...
| [`dataflow.mmd`](dataflow.mmd) | Every `@flows` between components, with trust boundaries drawn as zones. | 170 edges — **past the readable size** |
...
Generated by guardlink@2.0.0 from annotation hash `sha256-v3:39b3f1e648d4b08fe8632ac7a8b74a62ad0afa5170f3345766b66901d4a244e1`. If that
