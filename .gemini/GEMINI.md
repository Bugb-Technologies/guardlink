...
- #mcp exposed to #data-exposure [medium] (src/mcp/server.ts:41)
...
- SavedReport -> #llm-client via parseFindingsBlock
...
- … and 164 more — `guardlink_lookup("flows into X")` for one asset, or `guardlink_graph(from: X)` for a neighbourhood
...
820 annotations, 19 assets, 16 threats, 14 controls, 121 exposures, 0 confirmed, 125 mitigations, 3 actors, 1 entitlements, 184 flows, 2 features

### Block Freshness

- `annotation_hash`: `sha256-v3:637e8b9ebe8d7cb54f21eb70a069447a3a5a7b9d7dc0ec3e139dc2511c1ba175`
