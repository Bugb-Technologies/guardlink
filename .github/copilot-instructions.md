...
- … and 118 more — `guardlink_lookup("flows into X")` for one asset, or `guardlink_graph(from: X)` for a neighbourhood
...
574 annotations, 17 assets, 15 threats, 13 controls, 97 exposures, 0 confirmed, 90 mitigations, 3 actors, 1 entitlements, 138 flows, 2 features

### Block Freshness

- `annotation_hash`: `sha256-v2:f185cb0f2b7551e204d6a238e33edc80c5a752f5aacb897be2d164cb9679dce6`
