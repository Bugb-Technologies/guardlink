...
- … and 90 more — `guardlink_lookup("flows into X")` for one asset, or `guardlink_graph(from: X)` for a neighbourhood
...
462 annotations, 16 assets, 15 threats, 12 controls, 80 exposures, 0 confirmed, 72 mitigations, 3 actors, 1 entitlements, 110 flows, 2 features
